    ...
    return (
        <section className="px-5 py-20 bg-gray-50">
            <div className="container mx-auto text-center space-y-8">
                {/* Section Heading */}
                <div>
                    <h2 className="text-4xl font-mustard text-gray-900">What Our Users Say</h2>
                        ...
                        <li class="text-sm leading-6">
                            <div class="relative group">
                                <a href="https://twitter.com/kanyewest" class="cursor-pointer">
                                    <div class="relative p-6 space-y-6 leading-none rounded-2xl bg-white shadow-xl">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-900 text-md">Rapper &amp; Entrepreneur</p>
                                            </div>
                                        </div>
                                        <p class="leading-normal text-gray-700 text-md">Find God.</p>
                                    </div>
                                </a>
                            </div>
                        </li>
                                    ...
                                    <div class="relative p-6 space-y-6 leading-none rounded-2xl bg-white shadow-xl">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-900 text-md">CEO of Apple</p>
                                            </div>
                                        </div>
                                        <p class="leading-normal text-gray-900 text-md">Diam quis enim lobortis scelerisque
                                    ...
                                    <div class="relative p-6 space-y-6 leading-none rounded-2xl bg-white shadow-xl">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-900 text-md">CEO of Twitter</p>
                                            </div>
                                        </div>
                                        <p class="leading-normal text-gray-900 text-md">Enim neque volutpat ac tincidunt vitae
                                    ...
                                    <div class="relative p-6 space-y-6 leading-none rounded-2xl bg-white shadow-xl">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-900 text-md">CEO of Microsoft</p>
                                            </div>
                                        </div>
                                        <p class="leading-normal text-gray-900 text-md">Tortor dignissim convallis aenean et
                                    ...
                                    <div class="relative p-6 space-y-6 leading-none rounded-2xl bg-white shadow-xl">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-900 text-md">CEO of PayPal</p>
                                            </div>
                                        </div>
                                        <p class="leading-normal text-gray-900 text-md">Quam pellentesque nec nam aliquam sem
